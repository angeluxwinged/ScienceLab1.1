<?php
	...
	$columns = ["idCitaTHC", "nombre", "edad", "genero", "domicilio", "nacionalidad", "telefono", "fechaCita"];
	$columnsW = ["idCitaTHC", "nombre"];
	$table = "citaTHC";
	$id = 'idCitaTHC';
	...
	if($num_rows > 0){
		while($row = $resultado->fetch_assoc()){
			$output['data'] .= "<tr>";
			$output['data'] .= "<td>".$row["idCitaTHC"]."</td>";
			...
			$output['data'] .= "<td><a style='text-decoration: none; color: #000; border: 1px solid #414141; background-color: #dcbaff;' href='' data-bs-toggle='modal' data-bs-target='#editaModal' data-bs-id='" . $row["idCitaTHC"] . "'>Editar</a></td>";
			$output['data'] .= "<td><a style='text-decoration: none; color: #000; border: 1px solid #414141; background-color: #dc3545;' href='' data-bs-toggle='modal' data-bs-target='#eliminaModal' data-bs-id='" . $row["idCitaTHC"] . "'>Eliminar</a></td>";
			$output['data'] .= "</tr>";
		}
	}else{
		$output['data'] .= "<tr>";
